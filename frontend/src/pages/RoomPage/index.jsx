    ...
    return (
        <div className="row">
            <button type="button"
                ...
                className="btn btn-dark" style={{ display: "block", position: "absolute", top: "5%", left: "5%", height: "40px", width: "100px" }}>
                Users</button>
            <button type="button"
                onClick={() => setOpenedChatTab(true)}
                className="btn btn-primary" style={{ display: "block", position: "absolute", top: "5%", left: "10%", height: "40px", width: "100px" }}>
                Chat</button>
            {
                openedUserTab && (
            ...
            {
                openedChatTab &&
                <Chat setOpenedChatTab={setOpenedChatTab} socket={socket}></Chat>
            }
